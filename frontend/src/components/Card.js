...
function Card(props) {
  ...
  const isOwn = (props.card.owner._id === currentUser._id) || (props.card.owner === currentUser._id);
  ...
  const isLiked = props.card.likes.some((i) => (i._id === currentUser._id) || (i === currentUser._id));
